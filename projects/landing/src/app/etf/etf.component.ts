...
import { AfterViewInit, ChangeDetectionStrategy, Component, inject, Inject, OnDestroy, PLATFORM_ID, signal } from '@angular/core';
...
import { EtfFeaturesComponent } from './etf-features/etf-features.component';
...
@Component({
  selector: 'app-etf',
  standalone: true,
  imports: [NgClass, FaIconComponent, NgbCarouselModule, ProfitCalculatorComponent, NgbTooltip,LinkingGadgetComponent,
    CommonModule, FontAwesomeModule, FooterComponent, ContactGadgetComponent, FormsModule, EtfFeaturesComponent, FundCompositionComponent],
  templateUrl: './etf.component.html',
  styleUrl: './etf.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class EtfComponent implements AfterViewInit, OnDestroy {
  ...
  faqs = [

    {
      ...
      question: 'پیش نیاز سرمایه‌گذاری در صندوق پاسارگاد چیست؟',
      answer: 'برای شروع سرمایه‌گذاری در صندوق پاسارگاد سرمایه‌گذاران تنها به کد بورسی نیاز دارند. اگر تا به امروز کد بورسی خود را دریافت نکرده‌اید می‌توانید با مراجعه سامانه سجام (Sejam.ir) و ثبت اطلاعات هویتی به صورت کاملا غیرحضوری کد بورسی خود را دریافت کنید.',
      collapsed: true

    },
    {
      question: 'حداقل سرمایه مورد نیاز برای سرمایه‌گذاری در صندوق پاسارگاد چقدر است؟',
      answer: 'سرمایه‌گذاری در صندوق پاسارگاد از طریق سامانه آی‌پاسارگاد با حداقل مبلغ 100 هزار تومان قابل انجام است.',
      collapsed: true
    },

    {
      question: 'تقسیم سود صندوق پاسارگاد به چه صورت است؟',
      answer: 'صندوق پاسارگاد از نوع قابل معامله در بورس (ETF) و بدون توزیع سود است. در این صندوق سود حاصل از سرمایه‌گذاری روزانه به ارزش واحدهای صندوق اضافه می‌شود و سرمایه‌گذاران می‌توانند در هر زمان دلخواه با فروش قسمتی یا کل واحدها هر میزان از مجموع اصل و سود سرمایه‌گذاری خود را نقد کنند. ',
      collapsed: true

    },

    {
      question: 'فروش واحدهای صندوق پاسارگاد به چه شکل انجام می‌شود؟',
      answer: 'سرمایه‌گذاران می‌توانند با مراجعه به پنل معاملاتی کارگزاری خود در روزها و ساعات کاری بورس یا مراجعه به حساب کاربری آی‌پاسارگاد خود در هر زمان دلخواه، واحدهای خود را به قیمت لحظه‌ای به فروش برسانند. ',
      collapsed: true

    },

    {
      question: 'پس از فروش واحدهای پاسارگاد، مبلغ کی به حساب سرمایه‌گذار واریز می‌شود؟',
      answer: 'اگر درخواست برداشت وجه در روزهای کاری شنبه تا چهارشنبه قبل از ساعت ۱۴:۳۰ ثبت شود، یک روز کاری بعد و در صورت ثبت درخواست برداشت وجه بعد از ساعت ۱۴:۳۰، دو روز کاری بعد مبلغ به حساب بانکی سجامی سرمایه‌گذار واریز می‌شود.',
      collapsed: true
  ...
  onSaveLandingTicketClick() {
    ...
    const body = {
      fullName: "Pasargad ETF Landing",
      nationalId: "Pasargad ETF Landing",
      mobile: this.mobileValue,
      email: "Pasargad ETF Landing",
      subject: "Pasargad ETF Landing",
      code: 3,
      message: "Pasargad ETF Landing"
    };
