...
export class DashboardComponent implements OnInit, OnDestroy {
  ...
  readonly mockFundCards = [
    { title: 'هزاره سوم', symbol: 'هزاره سوم', seoRegisterNumber: 11168, imageSrc: 'assets/images/funds/hezareh-sevom.svg', type: 'درآمد ثابت صدور و ابطالی', typeLabel: 'درآمد ثابت', isEtf: false, managerLabel: 'صندوق هزاره سوم پاد', description: 'مناسب سرمایه‌گذاری کم‌ریسک؛ هدف، درآمد پایدار با امکان صدور و ابطال.', isFeatured: true, value: 485000000, returnText: '31.3%', returnTone: 'positive', trend: 'بازده روز', tradeValueLabel: '۰.۴۸ همت', transactionValueLabel: '۴۸۵ میلیون ریال', dailyReturnLabel: '۲۸.۵٪', tone: 'green' },
    { title: 'پاسارگاد', symbol: 'پاسارگاد', seoRegisterNumber: 11355, imageSrc: 'assets/images/funds/pasargad.svg', type: 'درآمد ثابت قابل معامله', typeLabel: 'درآمد ثابت', isEtf: true, managerLabel: 'صندوق درآمد ثابت پاسارگاد', description: 'مناسب سرمایه‌گذاران ریسک‌گریز؛ هدف، حفظ اصل سرمایه و کسب بازدهی منظم.', value: 132000000, returnText: '39%', returnTone: 'positive', trend: 'بازده روز', tradeValueLabel: '۰.۱۳ همت', transactionValueLabel: '۱۳۲ میلیون ریال', dailyReturnLabel: '۲۷.۹٪', tone: 'green' },
    { title: 'ریتون', symbol: 'ریتون', seoRegisterNumber: 11421, imageSrc: 'assets/images/funds/riton.svg', type: 'طلای قابل معامله', typeLabel: 'طلا', isEtf: true, managerLabel: 'صندوق چندکالایی پاسارگاد', description: 'مناسب پوشش ریسک تورم و طلا؛ هدف، همراهی با نوسان قیمت طلا.', value: 92000000, returnText: '48.24%', returnTone: 'positive', trend: 'بازده روز', tradeValueLabel: '۰.۰۹ همت', transactionValueLabel: '۹۲ میلیون ریال', dailyReturnLabel: '۳۴.۲٪', tone: 'gold' },
    { title: 'تکپاد', symbol: 'تکپاد', seoRegisterNumber: 11509, imageSrc: 'assets/images/funds/tekpad.svg', type: 'سهامی قابل معامله', typeLabel: 'سهامی', isEtf: true, managerLabel: 'صندوق ارزش پرداز آریان', description: 'مناسب سرمایه‌گذاران ریسک‌پذیر؛ هدف، رشد سرمایه از بازار سهام.', value: 64000000, returnText: '41.78%', returnTone: 'positive', trend: 'بازده روز', tradeValueLabel: '۰.۰۶ همت', transactionValueLabel: '۶۴ میلیون ریال', dailyReturnLabel: '۴۱.۷٪', tone: 'purple' }
  ];
